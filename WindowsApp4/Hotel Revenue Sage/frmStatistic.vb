...
Public Class frmStatistic
    ...
    Private Sub BtnImport_Click(sender As Object, e As EventArgs) Handles BtnImport.Click
        If DataGridView1.RowCount > 1 Then
            ...
            GLbatch.Fields.FieldByName("BTCHDESC").SetValue("Daily Statistic for " & DateTimePicker1.Value.ToString("dd-MMM-yy "), False)   ' Description
            ...
            If txtvariance.Text.Trim <> "" Then
                ...
                GLdetail1.Fields.FieldByName("PROCESSCMD").SetValue("0", False)      ' Process switches
                GLdetail1.Fields.FieldByName("TRANSDESC").SetValue("Daily Statistic for " & DateTimePicker1.Value.ToString("dd-MMM-yy "), False)   ' Description
