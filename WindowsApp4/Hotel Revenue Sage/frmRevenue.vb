...
Public Class frmRevenue
    ...
    Public Sub LoadData()
        ...
        Dim col6 As Integer = 15  'previous 30
        ...
        Try
            ...
            Dim rowStart As Integer = 1  'Previous 2nd line
                ...
                If lineNum >= rowStart Then
                    ...
                    For i As Integer = 0 To colCount - 1
                        ...
                        If i = 3 Then
                            ...
                            Dim d As String = v.Substring(v.Length - 1, 1)
                            Dim n As Decimal = If((d = "D"), -1, 1)
    ...
    Private Sub BtnImport_Click(sender As Object, e As EventArgs) Handles BtnImport.Click
        If DataGridView1.RowCount > 1 Then
            ...
            GLbatch.Fields.FieldByName("BTCHDESC").SetValue("Daily Revenue for " & DateTimePicker1.Value.ToString("dd-MMM-yy "), False)   ' Description
